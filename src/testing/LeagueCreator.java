...
public class LeagueCreator {
	 ...
	 */
	public LeagueCreator(String leagueName, int[] apiId, String datasetName, int matchDay) {
		this.apiId = apiId;
	...
	public void createLeague() {
		...
		for (int i = 0; i < apiId.length; i++) {
			...
			try {
				...
				// Create the fixtures
				FixtureHandler.createFixtures(season, trainingSet, currentMatchday);
